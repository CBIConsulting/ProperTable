...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formatters = __webpack_require__(67);
	...
	var _reactDimensions = __webpack_require__(70);
	...
	var ProperTable = function (_React$Component) {
		...
		_createClass(ProperTable, [{
			...
			value: function shouldComponentUpdate(nextProps, nextState) {
				...
				if (!_underscore2['default'].isEqual(nextProps.data, this.props.data)) {
					this.initData();
					this.setDefaultSelection();
					this.sortTable(this.state.colSortDirs);
					changed = true;
				...
				if (!_underscore2['default'].isEqual(nextProps.cols, this.props.cols)) {
					this.setState({
						cols: _immutable2['default'].fromJS(this.props.cols)
					});
					this.sortTable(this.state.colSortDirs);
					changed = true;
				}
			...
			value: function sendSelection() {
				...
				if (typeof this.props.afterSelect == 'function') {
					(function () {
						...
						selection = [].concat(_toConsumableArray(selection)); // Parse from Set to Array
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _numeral = __webpack_require__(69);
